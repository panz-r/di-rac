...
Language parse_language_name(const char *name) {
    ...
    if (strcmp(name, "python") == 0 || strcmp(name, "py") == 0) return LANG_PYTHON;
    if (strcmp(name, "typescript") == 0 || strcmp(name, "ts") == 0 || strcmp(name, "tsx") == 0) return LANG_TYPESCRIPT;
    if (strcmp(name, "javascript") == 0 || strcmp(name, "js") == 0 || strcmp(name, "jsx") == 0) return LANG_JAVASCRIPT;
    if (strcmp(name, "c") == 0) return LANG_C;
    if (strcmp(name, "cpp") == 0 || strcmp(name, "cc") == 0 || strcmp(name, "cxx") == 0 || strcmp(name, "h") == 0 || strcmp(name, "hpp") == 0) return LANG_CPP;
    if (strcmp(name, "rust") == 0 || strcmp(name, "rs") == 0) return LANG_RUST;
    if (strcmp(name, "go") == 0) return LANG_GO;
    if (strcmp(name, "bash") == 0 || strcmp(name, "sh") == 0) return LANG_BASH;
    if (strcmp(name, "java") == 0) return LANG_JAVA;
    if (strcmp(name, "csharp") == 0 || strcmp(name, "cs") == 0) return LANG_CSHARP;
    if (strcmp(name, "ruby") == 0 || strcmp(name, "rb") == 0) return LANG_RUBY;
