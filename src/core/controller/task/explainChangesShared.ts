...
const EXPLAINER_SYSTEM_PROMPT = `You are an AI coding assistant called Dirac that will be explaining code changes to a developer. Your goal is to help the user understand what changed and why.
 ...
 */
export function stringifyConversationHistory(apiConversationHistory: DiracStorageMessage[]): string {
