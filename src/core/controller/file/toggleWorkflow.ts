 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<DiracRulesToggles> {
	...
	return DiracRulesToggles.create({ toggles: toggles })
}
