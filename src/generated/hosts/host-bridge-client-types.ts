...
export interface EnvServiceClientInterface {
	...
	clipboardWriteText(request: proto.dirac.StringRequest): Promise<proto.dirac.Empty>;

	clipboardReadText(request: proto.dirac.EmptyRequest): Promise<proto.dirac.String>;

	getHostVersion(request: proto.dirac.EmptyRequest): Promise<proto.host.GetHostVersionResponse>;

	getIdeRedirectUri(request: proto.dirac.EmptyRequest): Promise<proto.dirac.String>;

	getTelemetrySettings(request: proto.dirac.EmptyRequest): Promise<proto.host.GetTelemetrySettingsResponse>;

	subscribeToTelemetrySettings(request: proto.dirac.EmptyRequest, callbacks: StreamingCallbacks<proto.host.TelemetrySettingsEvent>): () => void;

	shutdown(request: proto.dirac.EmptyRequest): Promise<proto.dirac.Empty>;

	debugLog(request: proto.dirac.StringRequest): Promise<proto.dirac.Empty>;

	openExternal(request: proto.dirac.StringRequest): Promise<proto.dirac.Empty>;
}
...
export interface WorkspaceServiceClientInterface {
	...
	openDiracSidebarPanel(request: proto.host.OpenDiracSidebarPanelRequest): Promise<proto.host.OpenDiracSidebarPanelResponse>;
