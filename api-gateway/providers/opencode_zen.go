...
// OpenCodeZenHandler handles OpenCode Zen API requests.
// OpenCode Zen is a pay-as-you-go service for models from OpenAI, Anthropic, Google, etc.
//   - Base URL: https://opencode.ai/zen/v1 (all models via /chat/completions)
//   - Model prefix: opencode/ (stripped before API calls)
//   - API: OpenAI-compatible (/chat/completions)
//   - Default model: gpt-4
type OpenCodeZenHandler struct {
	inner *openaiCompatHandler
}

func NewOpenCodeZenHandler() *OpenCodeZenHandler {
	return &OpenCodeZenHandler{
		inner: newOpenAICompatHandler(OpenAICompatConfig{
			BaseURL:      "https://opencode.ai/zen/v1",
			DefaultModel: "opencode/gpt-4",
...
func (h *OpenCodeZenHandler) Send(ctx context.Context, req *Request) (*SendResult, error) {
...
func (h *OpenCodeZenHandler) ValidateSettings(settings map[string]interface{}, thinking *ThinkingConfig) *ValidateSettingsResult {
...
// ListModels fetches available models from the OpenCode Zen API.
func (h *OpenCodeZenHandler) ListModels(ctx context.Context, cfg ProviderConfig) ([]ModelEntry, error) {
	...
	if resp.StatusCode != http.StatusOK {
		...
		return nil, fmt.Errorf("OpenCode Zen /models returned status %d: %s", resp.StatusCode, string(errBody))
	}
...
var _ Handler = (*OpenCodeZenHandler)(nil)
var _ CapableHandler = (*OpenCodeZenHandler)(nil)
var _ SettingsValidator = (*OpenCodeZenHandler)(nil)
var _ ModelLister = (*OpenCodeZenHandler)(nil)
