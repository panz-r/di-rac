use crate::daemons::{ResilientDaemon, AnalyzerRequest, AnalyzerResponse};
...
pub async fn symbols(
    ...
    match subcommand {
        "search" => symbol_search(analyzer_daemon, call).await,
        "replace" => symbol_replace(analyzer_daemon, call).await,
        "rename" => symbol_rename(analyzer_daemon, call).await,
        "refs" => symbol_refs(analyzer_daemon, call).await,
